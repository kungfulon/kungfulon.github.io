...
var routes = [
    ...
    { path: 'article/:id', component: _article_article_component__WEBPACK_IMPORTED_MODULE_4__["ArticleComponent"] },
    { path: '**', redirectTo: '/' }
];
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_7__["library"].add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_8__["faTags"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_8__["faPaperclip"], _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_9__["faFacebook"], _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_9__["faTwitter"], _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_9__["faGithub"]);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                ngx_markdown__WEBPACK_IMPORTED_MODULE_5__["MarkdownModule"].forRoot({ loader: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }),
...
var ArticleService = /** @class */ (function () {
    ...
    ArticleService.prototype.getArticles = function () {
        return this.httpClient.get("assets/articles.json");
    };
    ArticleService.prototype.getArticle = function (id) {
        return this.httpClient.get("assets/articles/" + id + ".json");
    };
...
module.exports = "<div *ngIf=\"article\" class=\"card\">\n  <div class=\"card-header\">\n    <h4>{{article.title}}</h4>\n    <div *ngIf=\"article.tags && article.tags.length > 0\">\n      <fa-icon [icon]=\"['fas', 'tags']\" class=\"mr-1\"></fa-icon>  \n      <span *ngFor=\"let tag of article.tags\" class=\"badge badge-primary mr-1\">\n        {{tag}}\n      </span>\n    </div>\n    <div *ngIf=\"article.attachments && article.attachments.length > 0\">\n      <fa-icon [icon]=\"['fas', 'paperclip']\" class=\"mr-1\"></fa-icon>  \n      <a *ngFor=\"let attachment of article.attachments\" href=\"{{attachment.url}}\" class=\"badge badge-secondary mr-1\">\n        {{attachment.title}}\n      </a>\n    </div>\n  </div>\n  <div class=\"card-body\">\n    <markdown *ngIf=\"article.url\" src=\"{{article.url}}\"></markdown>\n  </div>\n</div>\n"
...
var ArticleComponent = /** @class */ (function () {
    function ArticleComponent(articleService, activatedRoute, router) {
    ...
    ArticleComponent.prototype.ngOnInit = function () {
        ...
        this.articleService.getArticle(id).subscribe(function (data) {
            _this.article = data;
        });
    };
    ArticleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_article_service__WEBPACK_IMPORTED_MODULE_3__["ArticleService"],
...
module.exports = "<h2>Links</h2>\n<div class=\"mb-3\">\n  <a href=\"https://www.facebook.com/bienpnn\" class=\"btn btn-light mr-1\">\n    <fa-icon [icon]=\"['fab', 'facebook']\" size=\"3x\"></fa-icon>\n  </a>\n  <a href=\"https://twitter.com/bienpnn\" class=\"btn btn-light mr-1\">\n    <fa-icon [icon]=\"['fab', 'twitter']\" size=\"3x\"></fa-icon>\n  </a>\n  <a href=\"https://github.com/kungfulon\" class=\"btn btn-light mr-1\">\n    <fa-icon [icon]=\"['fab', 'github']\" size=\"3x\"></fa-icon>\n  </a>\n</div>\n<h2>Articles</h2>\n<div *ngIf=\"articles\" class=\"list-group\">\n  <div *ngFor=\"let article of articles; let id = index\" class=\"list-group-item\">\n    <a routerLink=\"/article/{{id + 1}}\" class=\"mr-2\">{{article.title}}</a>\n    <span *ngFor=\"let tag of article.tags\" class=\"badge badge-primary mr-1\">\n      {{tag}}\n    </span>\n  </div>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(articleService, router) {
        this.articleService = articleService;
        this.router = router;
    }
...
module.exports = __webpack_require__(/*! /home/bienpnn/blog/src/main.ts */"./src/main.ts");
